  ...
  try {
    ...
    try {
      if (process.env.EMAIL_USER && process.env.EMAIL_PASS) {
        ...
        await transporter.sendMail({
          from: `"Akshaya Builders & Developers Developers" <${process.env.EMAIL_USER}>`,
          to: email,
          subject: `📄 Your ${projectTitle} Brochure is Ready!`,
          html: `
            <div style="font-family:Arial,sans-serif;max-width:600px;margin:0 auto;background:#fdf6ec;padding:30px;border-radius:12px;">
              <div style="text-align:center;margin-bottom:20px;">
                <h1 style="color:#0d7377;font-family:Georgia,serif;margin:0;">Akshaya Builders & Developers</h1>
              </div>
              ...
              <p style="color:#999;font-size:11px;text-align:center;">
                © ${new Date().getFullYear()} Akshaya Builders & Developers Developers. All rights reserved.
              </p>
            </div>
          `,
        });
